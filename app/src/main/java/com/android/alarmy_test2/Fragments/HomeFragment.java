...
public class HomeFragment extends Fragment implements OnToggleAlarmListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAddFastFab.setOnClickListener(view -> {
            ...
            Log.d("Minute before click of Fast Alarm", String.valueOf(minute));
            btn60min.setOnClickListener(view1 -> {
                ...
                Log.d("Minute of Button 60 minute", String.valueOf(minute));
                Log.d("Hour of Button 60 minute", String.valueOf(hour));
            ...
            btn30min.setOnClickListener(view1 -> {
                ...
                Log.d("Minute of Button 30 minute", String.valueOf(minute));
                Log.d("Hour of Button 30 minute", String.valueOf(hour));
                time.setText(new StringBuilder().append("+ ").append(hour).append(" : ").append(minute).toString());
            });
            ...
            btn15min.setOnClickListener(view1 -> {
                ...
                Log.d("Minute of Button 15 minute", String.valueOf(minute));
                Log.d("Hour of Button 15 minute", String.valueOf(hour));
                time.setText(new StringBuilder().append("+ ").append(hour).append(" : ").append(minute).toString());
            });
            ...
            btn10min.setOnClickListener(view1 -> {
                ...
                Log.d("Minute of Button 10 minute", String.valueOf(minute));
                Log.d("Hour of Button 10 minute", String.valueOf(hour));
                time.setText(new StringBuilder().append("+ ").append(hour).append(" : ").append(minute).toString());
            });
            ...
            btn5min.setOnClickListener(view1 -> {
                ...
                Log.d("Minute of Button 5 minute", String.valueOf(minute));
                Log.d("Hour of Button 5 minute", String.valueOf(hour));
                time.setText(new StringBuilder().append("+ ").append(hour).append(" : ").append(minute).toString());
            });
            ...
            btn1min.setOnClickListener(view1 -> {
                ...
                Log.d("Minute of Button 1 minute", String.valueOf(minute));
                Log.d("Hour of Button 1 minute", String.valueOf(hour));
                time.setText(new StringBuilder().append("+ ").append(hour).append(" : ").append(minute).toString());
            });
            ...
            save.setOnClickListener(view12 -> {
                ...
                Log.d("Minute get ", String.valueOf(minute.get()));
                Log.d("Minute Calendar ", String.valueOf(calendar.get(Calendar.MINUTE)));
                Log.d("Hour Calendar", String.valueOf(calendar.get(Calendar.HOUR_OF_DAY)));
                Alarm alarm = new Alarm(alarmId,calendar.get(Calendar.HOUR_OF_DAY), calendar.get(Calendar.MINUTE), false, false, false, false, false, false, false
    ...
    ActivityResultLauncher<Intent> startForResult = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
        ...
        public void onActivityResult(ActivityResult result) {
            ...
            if (result != null && Objects.requireNonNull(result.getData()).getIntExtra(AddAlarm.EXTRA_ADD_OR_EDIT, 0) == 0  && result.getResultCode() == Activity.RESULT_OK) {
                ...
                Alarm alarm = new Alarm(alarmId,timeHour, timeMinute, mRepeatingDays[0], mRepeatingDays[1], mRepeatingDays[2], mRepeatingDays[3], mRepeatingDays[4], mRepeatingDays[5], mRepeatingDays[6]
